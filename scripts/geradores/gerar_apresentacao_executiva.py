...
OUT_PPT = ROOT / "entregaveis" / "apresentacao_executiva.pptx"
...
cards = [
    ...
    (C_BLUE,  "2. Salário diferente\npela mesma função",
     "Após controlar todas as características observáveis, negros ainda recebem 6,2% menos na mesma função. No topo salarial esse gap chega a 12%.",
