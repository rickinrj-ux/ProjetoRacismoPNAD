\begin{table}[H]
  ...
  \begin{tabular}{clrrrrr}
    ...
    \midrule
  P1 & Cotas ocupacionais CBO 1–4 & 0.1053 & 0.35 & 1.5 & 2 & 1.00 \\
...
\begin{table}[H]
  ...
  \begin{tabular}{rlrrrr}
    ...
    \midrule
  1 & Cotas ocupacionais CBO 1–4 & 0.0369 & 0.0860 & 0.233 & 0.7986 \\
  2 & Equidade educacional (cotas/bolsas) & 0.0444 & 0.0150 & 0.125 & 0.5576 \\
  3 & Mentoria e redes profissionais & 0.0152 & 0.0263 & 0.300 & 0.3875 \\
  4 & Transparência salarial obrigatória & 0.0048 & 0.0080 & 0.312 & 0.3242 \\
  5 & Enforcement anti-discriminação & 0.0136 & 0.0128 & 0.167 & 0.2405 \\
  6 & Desegregação residencial & 0.0111 & 0.0046 & 0.025 & 0.1089 \\
    \bottomrule
  \end{tabular}
\end{table}
