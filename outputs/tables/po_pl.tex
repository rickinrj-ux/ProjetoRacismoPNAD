\begin{table}[H]
  ...
  \begin{tabular}{rrrrrrrrr}
    ...
    $x_1$ & $x_2$ & $x_3$ & $x_4$ \\
    \midrule
  2 & 0.429 & 0.074 & 17.2\% & 0.355 & 0.00 & 0.00 & 0.67 & 1.00 \\
  3 & 0.429 & 0.094 & 21.9\% & 0.335 & 0.42 & 0.00 & 1.00 & 1.00 \\
  4 & 0.429 & 0.108 & 25.1\% & 0.321 & 1.00 & 0.12 & 1.00 & 1.00 \\
  5 & 0.429 & 0.111 & 25.9\% & 0.318 & 1.00 & 0.52 & 1.00 & 1.00 \\
  6 & 0.429 & 0.114 & 26.6\% & 0.315 & 1.00 & 0.92 & 1.00 & 1.00 \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
  Enforcement anti-discriminação & $0.1128$ & $0.20$ & $1.2$ & $0.0226$ \\
  Desegregação residencial & $0.0514$ & $0.15$ & $2.5$ & $0.0077$ \\
  Equidade educacional & $0.1065$ & $0.30$ & $1.5$ & $0.0319$ \\
  Acesso a redes / brokerage & $0.2098$ & $0.25$ & $1.0$ & $0.0524$ \\
    \bottomrule
  \end{tabular}
\end{table}
