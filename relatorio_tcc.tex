...
($|\text{SHAP}| = 0.275$), seguida de gênero e escolaridade superior,
...
($|\text{SHAP}|=0.275$), while race ranks
...
($|\text{SHAP}| = 0.275$), com peso três vezes maior que
