...
O critério Silhouette em $k=2$ ($S=0.1736$) apontou
solução binária trivial; $k=3$ ($S=0.1401$) foi adotado
...
O gap racial bruto de 19.3\% reduz-se para 9.7\% quando contextos
...
A mediação contextual de 52.5\% pelo bairro de moradia é o resultado
...
política dominante (CC~$=0,8344$), seguidas de
Equidade Educacional (CC~$=0,5879$), Mentoria e
Redes (CC~$=0,3962$), Transparência Salarial
(CC~$=0,3422$), Enforcement
(CC~$=0,2753$) e Desegregação Residencial
(CC~$=0,0805$). A programação linear confirma que
...
25,1\%, demonstrando que a convergência racial é
